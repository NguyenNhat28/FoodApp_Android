...
public class TinyDB {
    ...
    public ArrayList<FoodAppDomian> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodAppDomian> playerList =  new ArrayList<FoodAppDomian>();

        for(String jObjString : objStrings){
            FoodAppDomian player  = gson.fromJson(jObjString,  FoodAppDomian.class);
    ...
    public void putListObject(String key, ArrayList<FoodAppDomian> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodAppDomian player: playerList){
