...
public class ShowDetailActivity extends AppCompatActivity {
    ...
    private TextView titleTxt, feeTxt, descriptionTxt, numberOrderTxt, totalPriceTxt, starTxt, caloryTxt, timeTxt, Empty;
    private ImageView plusBtn, minusBtn, picFood;
    private FoodAppDomian object;
    ...
    private void getBundle() {
        object = (FoodAppDomian)getIntent().getSerializableExtra("object");
    ...
    private void iniView() {
        ...
        plusBtn = findViewById(R.id.plus_btn_Card);
        minusBtn = findViewById(R.id.minus_btn_Card);
